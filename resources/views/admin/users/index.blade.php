...
<div class="container">
  ...
  <tr>
        ...
        <td><img src="{{ asset('storage/images/users/'. $user->photo) }}" style="width:150px; height:150px;"></td>
        <td> {{ $user->created_at->diffForHumans() }} </td>
<td>
    <a href={{ URL::to('user/' . $user->id ) }} type="button" class="btn btn-success" >View</a></td>
